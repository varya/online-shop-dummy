  ...
  var cache,
    ...
    function apply() {
        ...
        if (__t === "mix") {
            ...
            if (__t === "goods") {
                ...
                if (!!this.elem === false) {
                    var _$1pctx = this.ctx, _$1pa = {
                        src: "//yandex.st/lego/_/La6qi18Z8LwgnZdsAr1qy1GwCwo.gif",
                        alt: ""
                    }, _$1pprops = [ "alt", "width", "height" ], _$1pp;
                ...
                if (!(this.elem === "cell" || this.elem === "gap") === false) {
                    var _$1jctx = this.ctx, _$1ja = {}, _$1jprops = [ "colspan", "rowspan" ], _$1jp;
            ...
            if (__t === "b-logo") {
                var __t = this.elem;
                if (__t === "icon") {
                    var _$1rctx = this.ctx;
                    {
                        "";
                        var __r81 = this._mode;
                        this._mode = "";
                        var __r82 = _$1rctx.elem;
                        _$1rctx.elem = undefined;
                        var __r83 = _$1rctx.block;
                        _$1rctx.block = "b-icon";
                        var __r84 = _$1rctx.mix;
                        _$1rctx.mix = [ {
                            block: "b-logo",
                            elem: "icon"
                        } ];
    ...
    function $114() {
        ...
        var _$1nctx = this.ctx, _$1nprops = [ "title", "target" ], _$1np = typeof _$1nctx.url, _$1na = {
            href: _$1np === "undefined" || _$1np === "string" ? _$1nctx.url : (_$1np = [], "", __r72 = this._buf, this._buf = _$1np, __r73 = this._mode, this._mode = "", __r74 = this.ctx, this.ctx = _$1nctx.url, __r75 = apply.call(__this), this._buf = __r72, this._mode = __r73, this.ctx = __r74, "", __r75, _$1np.join(""))
        };
    ...
    function $151() {
        ...
        for (var _$1ti = 0; _$1ti < 10; _$1ti++) {
            _$1tcontent.push({
                elem: "sizer"
            });
        }
    ...
    function $158() {
        ...
        this.ctx.under && _$1bc.content.push({
            elem: "row",
            content: [ {
                elem: "cell",
                mix: [ {
    ...
    function $187() {
        var _$1qctx = this.ctx, _$1qcontent = _$1qctx.content || _$1qctx.icon;
        _$1qctx.icon && (_$1qctx.icon.block = "b-logo");
        if (_$1qctx.content instanceof Array) {
            for (var _$1qc in _$1qctx.content) {
                _$1qctx.content[_$1qc].elem && (_$1qctx.content[_$1qc].block = "b-logo");
                _$1qctx.content[_$1qc].tag = "span";
            }
        } else {
            undefined;
        }
        {
            "";
            var __r76 = this._mode;
            this._mode = "";
            var __r77 = _$1qctx.elem;
            _$1qctx.elem = undefined;
            var __r78 = _$1qctx.block;
            _$1qctx.block = "b-link";
            var __r79 = _$1qctx.content;
            _$1qctx.content = _$1qcontent;
            var __r80 = _$1qctx.mix;
            _$1qctx.mix = [ {
                block: "b-logo",
                elem: "link"
            } ];
    ...
    function $199() {
        if (!(this["__$anflg"] !== 830009190) === false) {
            if (!!this.elem === false) {
