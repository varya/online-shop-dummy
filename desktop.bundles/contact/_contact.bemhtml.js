var BEMHTML = (function(exports) {
    ...
    function $19() {
        if (!(this["__$anflg"] !== 989215252) === false) {
            if (!!this.elem === false) {
                return $22.call(this);
            } else {
                return $230.call(this);
